...
{
    ResponseDto create(long bookId, CommentRequestDto body, long userId, boolean isAdmin);
    ...
    ResponseDto delete(long bookId, long commentId, long userId, boolean isAdmin);
}
